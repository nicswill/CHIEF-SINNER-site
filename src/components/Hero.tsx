  ...
  return (
    <div className="relative h-screen w-full bg-black overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-start h-full text-center px-4 sm:px-6 lg:px-8 mt-6">
        <h1
          className={`text-white text-5xl md:text-7xl lg:text-8xl font-black tracking-wide mb-4 transform transition-all duration-1000 ${
        ...
        <p
          className={`text-gray-200 text-xl md:text-2xl font-bold mb-4 max-w-2xl transform transition-all duration-1000 delay-300 ${
            loaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
        ...
        <div
          className={`mb-1 transform transition-all duration-1000 delay-500 ${
            loaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
          <Link
